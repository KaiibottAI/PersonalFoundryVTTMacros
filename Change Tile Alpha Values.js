let tileId = "XLTuyeG8hU1cKHJO"; // Replace this with the actual ID of your tile
  ...
  content: `
      <form>
        <div class="form-group">
          ...
          <input type="range" id="darknessLevel" name="darknessLevel" min="0" max="1" step="0.01" value="${tile.document.alpha}">
          <output for="darknessLevel" id="darknessOutput">${tile.document.alpha}</output>
        </div>
        <div class="form-group">
  ...
  buttons: {
    change: {
      ...
      callback: (html) => {
        ...
        let currentDarknessLevel = tile.document.alpha;
        ...
        for (let i = 1; i <= numSteps; i++) {
          setTimeout(() => {
            ...
            tile.document.update({ alpha: newDarknessLevel });
